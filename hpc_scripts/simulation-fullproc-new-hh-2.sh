...
WAVE=1
MODEL="hsgp-eq-rd-new-hh-rd-symmetric-poisson"
HSGP_C=1.5
HSGP_M=20
N=100
HHSIZE=4
...
Rscript $REPO_PATH/scripts/sim-run-stan-single-new-hh-2.R --sim.no $SIM_NO --iter_warmup $WARMUP --iter_sampling $SAMPLING --chains $CHAINS --hhsize $HHSIZE --sample_size $N --scenario $SCENARIO --model $MODEL --repo_path $REPO_PATH --data_path $DATA_PATH --hsgp_c $HSGP_C --hsgp_m $HSGP_M --wave $WAVE
