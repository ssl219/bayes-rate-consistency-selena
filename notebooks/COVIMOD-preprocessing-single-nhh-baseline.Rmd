...
p1
ggsave(file.path(fig.path, paste0("empirical-contact-intensity-nhh.png")), plot = p1, height = 20, width = 20, limitsize = FALSE)
```
```{r}
...
p2
ggsave(file.path(fig.path, paste0("log-contact-counts-nhh.png")), plot = p2, height = 20, width = 20, limitsize = FALSE)
```
