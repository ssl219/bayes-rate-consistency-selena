...
dt.cmb.agg.nhh <- dt.cmb.agg.nhh[!(age > 84 | alter_age_strata == "85+")]
...
p1
ggsave(file.path(fig.path, paste0("empirical-contact-intensity-nhh-wave1.png")), plot = p1, height = 20, width = 20, limitsize = FALSE)
```
```{r}
...
p2
ggsave(file.path(fig.path, paste0("log-contact-counts-nhh-wave1.png")), plot = p2, height = 20, width = 20, limitsize = FALSE)
```
