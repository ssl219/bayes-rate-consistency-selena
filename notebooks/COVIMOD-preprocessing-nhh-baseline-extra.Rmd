...
# type of nhh contact
type_nhh <- "friends and nhh family"
```
...
if (type_nhh == "friends and nhh family"){
  dt.nhh <- dt.nhh[relation=="Family (not in household)"]
}
...
if (type_nhh == "work"){
  saveRDS(covimod.processed, file=file.path(data.path, "data/COVIMOD/COVIMOD-multi-nhh-work.rds"))
}

if (type_nhh == "friends and nhh family"){
    saveRDS(covimod.processed, file=file.path(data.path, "data/COVIMOD/COVIMOD-multi-nhh-friends-family.rds"))
}

if (type_nhh == "school"){
    saveRDS(covimod.processed, file=file.path(data.path, "data/COVIMOD/COVIMOD-multi-nhh-school.rds"))
}

if (type_nhh == "other"){
    saveRDS(covimod.processed, file=file.path(data.path, "data/COVIMOD/COVIMOD-multi-nhh-other.rds"))
}
