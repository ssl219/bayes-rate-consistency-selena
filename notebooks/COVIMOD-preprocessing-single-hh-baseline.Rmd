...
p1
ggsave(file.path(fig.path, paste0("empirical-contact-intensity-hh.png")), plot = p1, height = 20, width = 20, limitsize = FALSE)
...
p2
ggsave(file.path(fig.path, paste0("log-contact-counts-hh.png")), plot = p2, height = 20, width = 20, limitsize = FALSE)
```
