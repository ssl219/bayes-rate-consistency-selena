...
dt.cmb <- dt.hh[,.(new_id, wave, alter_age_strata, alter_gender, y)]
...
saveRDS(covimod.processed, file=file.path(data.path, "data/COVIMOD/COVIMOD-multi-hh.rds"))
```
