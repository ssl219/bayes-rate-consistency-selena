...
# Load data
covimod <- readRDS(file.path(args$data.path, "data/COVIMOD/COVIMOD-single-nhh-school.rds"))
...
fit$save_object(file = file.path(export.path, paste0(args$model.name, "-nhh-school.rds")))
cat(" DONE!\n")
