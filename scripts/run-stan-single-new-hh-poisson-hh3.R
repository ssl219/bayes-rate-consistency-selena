...
# Load data
covimod.single.new.hh <- readRDS(file.path(args$data.path, "data/COVIMOD/COVIMOD-single-new-hh-hh3.rds"))
...
fit$save_object(file = file.path(export.path, paste0(args$model.name, "-hh3.rds")), save_warmup=FALSE)
cat(" DONE!\n")
