...
# Load data
covimod.single.new.hh <- readRDS(file.path(args$data.path, "data/COVIMOD/COVIMOD-single-new-hh-less4.rds"))
...
fit$save_object(file = file.path(export.path, paste0(args$model.name, "-hhless4.rds")))
cat(" DONE!\n")
