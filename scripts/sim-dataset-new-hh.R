...
for (sim_data in 1:10){
  ...
  saveRDS(d_comb_strata_plot, file=file.path(export.path, paste0("d_comb_strata_plot-hh", args$hhsize, "-", args$scenario, "-", args$size, "-amended.rds")))
  ...
  if (!args$divide.Hicb){
    ...
    ggsave(file.path(export.path, paste0("hh", args$hhsize, "-", args$scenario, "-", args$size, "-full-amended.pdf")), width = 20, height = 16, units = "cm")
  }else{
