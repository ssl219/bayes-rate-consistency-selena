...
# Load data
covimod <- readRDS(file.path(args$data.path, "data/COVIMOD/COVIMOD-single-nhh-work.rds"))
...
fit$save_object(file = file.path(export.path, paste0(args$model.name, "-nhh-work.rds")))
cat(" DONE!\n")
