...
option_list <- list(
  ...
  optparse::make_option("--wave", type="integer", default = 1,
                        help = "COVIMOD wave",
                        dest = "wave"),
  optparse::make_option("--model", type = "character", default = "hsgp-eq-cd-new-hh-dropping-all-zeros-symmetric-poisson-hh4-1",
...
data.path <- file.path(args$data.path, "data/COVIMOD/COVIMOD-single-new-hh4-random.rds")
