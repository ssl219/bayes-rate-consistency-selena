...
# Load data
covimod.single.new.hh <- readRDS(file.path(args$data.path, "data/COVIMOD/COVIMOD-single-new-hh-hhgreater5.rds"))
...
fit$save_object(file = file.path(export.path, paste0(args$model.name, "-hhgreater5.rds")), save_warmup=FALSE)
cat(" DONE!\n")
