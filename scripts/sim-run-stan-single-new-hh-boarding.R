...
# Load data
covimod.single.new.hh <- readRDS(file.path(args$data.path, "data/simulations/datasets/new-hh-boarding_school/data.rds"))
...
fit$save_object(file = file.path(export.path, paste0(args$model.name, "-sim-boarding.rds")))
cat(" DONE!\n")
