...
# Load data
covimod <- readRDS(file.path(args$data.path, "data/COVIMOD/COVIMOD-single-nhh-other.rds"))
...
fit$save_object(file = file.path(export.path, paste0(args$model.name, "-nhh-other.rds")))
cat(" DONE!\n")
