...
option_list <- list(
  ...
  optparse::make_option("--wave", type="integer", default = 1,
                        help = "COVIMOD wave",
                        dest = "wave"),
  optparse::make_option("--model", type = "character", default = "hsgp-eq-rd-new-hh-dropping-all-zeros-symmetric-poisson-1-hhless4",
...
data.path <- file.path(args$data.path, "data/COVIMOD/COVIMOD-single-new-hh-hhless4.rds")
